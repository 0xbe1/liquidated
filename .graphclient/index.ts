...
export type _SubgraphErrorPolicy_ =
  ...
  /** null **/
  liquidates: InContextSdkMethod<Aavev2Types.Query['liquidates'], Aavev2Types.QueryliquidatesArgs, MeshContext>,
  /** null **/
...
export type MeshContext = Aavev2Context & Compoundv2Context & BaseMeshContext;
